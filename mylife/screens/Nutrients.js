...
import Nutrients from "../components/NutrientsPage";
import Macros from "../components/MacrosPage";
export default class Login extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      loop={false}>
      <Nutrients navigation={this.props.navigation} date={date} />
      <Macros navigation={this.props.navigation} date={date} />
