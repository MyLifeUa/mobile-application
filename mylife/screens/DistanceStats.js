...
export default class Login extends React.Component {
  ...
  async getHeartStats() {
    ...
    console.log(
      `${API_URL}/health-stats/body/history/` +
        ...
        `?metric=distance&period=week`
    );

    fetch(
      `${API_URL}/health-stats/body/history/` +
        this.state.user_email +
        `?metric=distance&period=` +
  ...
  renderItem = ({ item, index }) => {
    ...
    return <HeartRateItem date={item.day} value={item.value} metrics={"Km"} />;
  };
      ...
      return (
        <LineChart
          data={{
            ...
            legend: ["Distance / Day", "Goal distance"] // optional
          }}
