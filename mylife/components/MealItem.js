...
export default class Register extends React.Component {
  ...
  selectPicture = async () => {
    ...
    renderItem = ({item, index}) => {
      ...
      return (
          <View style={{height:moderateScale(80),  borderBottomWidth: 1,borderColor:theme.gray}}>
                ...
                <View style={{flex:1.5,flexDirection:"row",alignItems:"flex-end",justifyContent:"flex-end",marginRight:10}}>
                    ...
                    <View style={styles.inputView3} >
                        <TextInput  
                            ...
                            maxLength={4}
                            keyboardType={'numeric'}
                            onChangeText={text => this.props.changeIngredientQuantity(this.props.position,text)}/>
                    </View>
                    <TouchableOpacity 
                          onPress={()=>{
                            this.props.deleteItem(this.props.position,this.props.id);
                        }
                      }
                    >
                      <Ionicons name="md-trash" size={moderateScale(30)} color={theme.red} style={{paddingHorizontal:15}}
